    ...
    <footer class="fixed sm:absolute inset-x-0 bottom-0 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:bottom-4 z-30 flex justify-center px-2 sm:px-4 pointer-events-none pb-[max(0.5rem,env(safe-area-inset-bottom))] sm:pb-0">
      <div class="pointer-events-auto w-full max-w-[min(100vw-0.5rem,28rem)] sm:max-w-none sm:w-auto bg-black/80 backdrop-blur-md rounded-t-2xl sm:rounded-2xl shadow-2xl border border-white/10 border-b-0 sm:border-b">
        <div class="reader-chrome-bar flex flex-row flex-nowrap items-center justify-center gap-0.5 px-1.5 py-1.5 sm:px-2 sm:py-2">
          ...
          <button type="button" id="reader-page-info" class="text-xs font-bold text-white min-w-[3.5rem] max-w-[5.5rem] text-center tabular-nums px-0.5 shrink-0 truncate rounded-md hover:bg-white/15 min-h-10 sm:min-h-9 inline-flex items-center justify-center cursor-pointer" title="Go to page" aria-label="Edit page number" aria-expanded="false" aria-controls="reader-page-jump-group">1 / 1</button>
          <div id="reader-page-jump-group" class="reader-page-jump-group flex items-center justify-center gap-1 shrink-0 max-w-[7.5rem]">
            <label for="reader-page-jump" class="sr-only">Go to page</label>
            <span class="reader-chrome-wide-only text-[10px] uppercase tracking-wide text-gray-500 shrink-0">Page</span>
          ...
          <button type="button" id="reader-last" class="reader-chrome-wide-only text-gray-100 hover:text-white min-h-10 min-w-10 sm:min-h-9 sm:min-w-9 inline-flex items-center justify-center rounded-md hover:bg-white/15 p-0.5 transition-colors shrink-0" title="Last page (End)"><span data-pub-icon="last_page" class="text-lg sm:text-xl"></span></button>
          ...
          <button type="button" id="reader-fit-reset" class="text-gray-400 hover:text-white min-h-9 min-w-9 sm:min-h-8 sm:min-w-8 inline-flex items-center justify-center rounded-md hover:bg-white/10 p-0.5 transition-colors shrink-0" title="Reset zoom to 100%"><span data-pub-icon="fit_screen" class="text-lg"></span></button>
