...
function bindReaderChromeControlsOnce() {
  ...
  document.addEventListener('click', (e) => {
    ...
    const actionEl = t.closest(
      '#reader-close, #reader-first, #reader-prev, #reader-next, #reader-last, #reader-zoom-in, #reader-zoom-out, #reader-fit-reset, #reader-fullscreen, #reader-page-jump-go, #reader-download-link, #reader-theme-toggle'
    );
    if (!actionEl) return;
